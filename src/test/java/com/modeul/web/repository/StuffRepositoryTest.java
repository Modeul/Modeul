...
class StuffRepositoryTest {
	...
	void testupdate() {
		...
		System.out.println("BeforeUpdateStuff : " + stuff);
		...
		System.out.println("AfterUpdateStuff : " + stuff);
	}
	...
	void testdeleteImage() {
		...
		Long stuffId = 365L;
		int deleteImageCount = repository.deleteImage(stuffId);
		System.out.printf("deleteImageCount: %d\n", deleteImageCount);
